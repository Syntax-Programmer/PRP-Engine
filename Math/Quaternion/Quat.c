...
MATH_QuatCreateEulerXYZ(MATH_EulerAngle angles) {
    ...
    PRP_F32 cx = MATH_CosF32(hx);
    PRP_F32 sx = MATH_SinF32(hx);
    PRP_F32 cy = MATH_CosF32(hy);
    PRP_F32 sy = MATH_SinF32(hy);
    PRP_F32 cz = MATH_CosF32(hz);
    PRP_F32 sz = MATH_SinF32(hz);
    MATH_Quat quat;
...
PRP_FN_API MATH_Quat PRP_FN_CALL MATH_QuatLog(MATH_Quat x) {
    ...
    PRP_F32 acos_term = MATH_ACosF32(MATH_ClampF32(x.w / q_len, -1, 1));
    PRP_F32 v_const;
