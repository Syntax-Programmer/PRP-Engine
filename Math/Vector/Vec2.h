...
static inline MATH_Vec2 MATH_Vec2Create(PRP_F32 x, PRP_F32 y) {
    return (MATH_Vec2){.x = x, .y = y};
}

static inline MATH_Vec2 MATH_Vec2CreateZero(void) { return (MATH_Vec2){0, 0}; }

static inline MATH_Vec2 MATH_Vec2CreateOne(void) { return (MATH_Vec2){1, 1}; }

static inline MATH_Vec2 MATH_Vec2CreateUnitX(void) {
    return (MATH_Vec2){.x = 1, .y = 0};
}

static inline MATH_Vec2 MATH_Vec2CreateUnitY(void) {
    return (MATH_Vec2){.x = 0, .y = 1};
}

static inline MATH_Vec2 MATH_Vec2CreateScalar(PRP_F32 s) {
...
static inline PRP_F32 MATH_Vec2Min(MATH_Vec2 a) {
    return MATH_MinF32(a.x, a.y);
}

static inline PRP_F32 MATH_Vec2Max(MATH_Vec2 a) {
    return MATH_MaxF32(a.x, a.y);
}

static inline PRP_Bool MATH_Vec2Eq(MATH_Vec2 a, MATH_Vec2 b) {
    return (PRP_Bool)(a.x == b.x && a.y == b.y);
}

static inline PRP_Bool MATH_Vec2AlmostEq(MATH_Vec2 a, MATH_Vec2 b) {
    return (PRP_Bool)(MATH_AlmostEqF32(a.x, b.x) && MATH_AlmostEqF32(a.y, b.y));
}

static inline PRP_Bool MATH_Vec2IsZero(MATH_Vec2 a) {
    return (PRP_Bool)(MATH_IsZeroF32(a.x) && MATH_IsZeroF32(a.y));
}

static inline PRP_Bool MATH_Vec2IsNaN(MATH_Vec2 a) {
    return (PRP_Bool)(MATH_IsNaNF32(a.x) || MATH_IsNaNF32(a.y));
}

static inline PRP_Bool MATH_Vec2IsInf(MATH_Vec2 a) {
...
static inline MATH_Vec2 MATH_Vec2AddScalar(MATH_Vec2 a, PRP_F32 s) {
    return (MATH_Vec2){.x = a.x + s, .y = a.y + s};
}

static inline MATH_Vec2 MATH_Vec2SubScalar(MATH_Vec2 a, PRP_F32 s) {
    return (MATH_Vec2){.x = a.x - s, .y = a.y - s};
}

static inline MATH_Vec2 MATH_Vec2MulScalar(MATH_Vec2 a, PRP_F32 s) {
    return (MATH_Vec2){.x = a.x * s, .y = a.y * s};
}

static inline MATH_Vec2 MATH_Vec2DivScalar(MATH_Vec2 a, PRP_F32 s) {
    return (MATH_Vec2){.x = a.x / s, .y = a.y / s};
}

static inline MATH_Vec2 MATH_Vec2DivScalarSafe(MATH_Vec2 a, PRP_F32 s,
                                               PRP_F32 fallback) {
    if (MATH_IsZeroF32(s)) {
...
static inline PRP_F32 MATH_Vec2Sum(MATH_Vec2 a) { return a.x + a.y; }

static inline PRP_F32 MATH_Vec2Avg(MATH_Vec2 a) {
    return (a.x + a.y) * (PRP_F32)(0.5f);
}
...
static inline PRP_F32 MATH_Vec2Dot(MATH_Vec2 a, MATH_Vec2 b) {
    return (a.x * b.x) + (a.y * b.y);
}

static inline PRP_F32 MATH_Vec2Cross(MATH_Vec2 a, MATH_Vec2 b) {
    return a.x * b.y - a.y * b.x;
}

static inline PRP_F32 MATH_Vec2LenSq(MATH_Vec2 a) { return MATH_Vec2Dot(a, a); }

static inline PRP_F32 MATH_Vec2Len(MATH_Vec2 a) {
    return MATH_SqrtF32(MATH_Vec2Dot(a, a));
}

static inline PRP_F32 MATH_Vec2Angle(MATH_Vec2 a, MATH_Vec2 b) {
    PRP_F32 denom = MATH_Vec2Len(a) * MATH_Vec2Len(b);
    PRP_F32 c = MATH_Vec2Dot(a, b) / denom;
    c = MATH_ClampF32(c, -1.0f, 1.0f);

    return MATH_ACosF32(c);
}

static inline PRP_F32 MATH_Vec2AngleSafe(MATH_Vec2 a, MATH_Vec2 b,
                                         PRP_F32 fallback) {
    PRP_F32 denom = MATH_Vec2Len(a) * MATH_Vec2Len(b);
...
static inline MATH_Vec2 MATH_Vec2ClampLen(MATH_Vec2 a, PRP_F32 min,
                                          PRP_F32 max) {
    PRP_F32 len = MATH_Vec2Len(a);
...
static inline MATH_Vec2 MATH_Vec2ClampLenSafe(MATH_Vec2 a, PRP_F32 min,
                                              PRP_F32 max, MATH_Vec2 fallback) {
    PRP_F32 len = MATH_Vec2Len(a);
...
static inline MATH_Vec2 MATH_Vec2ReciprocalSafe(MATH_Vec2 a, PRP_F32 fallback) {
...
static inline MATH_Vec2 MATH_Vec2Normalize(MATH_Vec2 a) {
    PRP_F32 inv_len = 1.0f / MATH_Vec2Len(a);
...
static inline PRP_Bool MATH_Vec2IsNormalized(MATH_Vec2 a) {
    return (PRP_Bool)(MATH_AlmostEqF32(MATH_Vec2LenSq(a), 1.0f));
}

static inline PRP_F32 MATH_Vec2Distance(MATH_Vec2 a, MATH_Vec2 b) {
    return MATH_Vec2Len(MATH_Vec2SubComps(a, b));
}

static inline PRP_F32 MATH_Vec2DistanceSq(MATH_Vec2 a, MATH_Vec2 b) {
...
static inline PRP_F32 MATH_Vec2AngleOf(MATH_Vec2 v) {
    return MATH_ATan2F32(v.y, v.x);
}

/* ----  SPECIAL OPS  ---- */

static inline MATH_Vec2 MATH_Vec2Rotate(MATH_Vec2 v, PRP_F32 angle) {
...
static inline MATH_Vec2 MATH_Vec2Lerp(MATH_Vec2 a, MATH_Vec2 b, PRP_F32 t) {
...
static inline MATH_Vec2 MATH_Vec2NLerp(MATH_Vec2 a, MATH_Vec2 b, PRP_F32 t) {
    MATH_Vec2 sub = MATH_Vec2SubComps(b, a);
    MATH_Vec2 sub_with_mul = MATH_Vec2MulScalar(sub, t);
...
static inline MATH_Vec2 MATH_Vec2Project(MATH_Vec2 a, MATH_Vec2 b) {
    PRP_F32 denom = MATH_Vec2Dot(b, b);
...
static inline MATH_Vec2 MATH_Vec2ProjectSafe(MATH_Vec2 a, MATH_Vec2 b,
    ...
    PRP_F32 s = MATH_Vec2Dot(a, b) / denom;
...
static inline MATH_Vec2 MATH_Vec2Reflect(MATH_Vec2 v, MATH_Vec2 n) {
    ...
    PRP_F32 d = 2.0f * MATH_Vec2Dot(v, n);
