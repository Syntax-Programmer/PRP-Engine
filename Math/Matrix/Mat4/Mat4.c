...
PRP_API PRP_Bool PRP_CALL MATH_Mat4IsOrthonormal(MATH_Mat4 a) {
    ...
    PRP_F32 d01 = MATH_Vec4Dot(c0, c1);
    PRP_F32 d02 = MATH_Vec4Dot(c0, c2);
    PRP_F32 d03 = MATH_Vec4Dot(c0, c3);
    PRP_F32 d12 = MATH_Vec4Dot(c1, c2);
    PRP_F32 d13 = MATH_Vec4Dot(c1, c3);
    PRP_F32 d23 = MATH_Vec4Dot(c2, c3);

    PRP_F32 l0 = MATH_Vec4LenSq(c0);
    PRP_F32 l1 = MATH_Vec4LenSq(c1);
    PRP_F32 l2 = MATH_Vec4LenSq(c2);
    PRP_F32 l3 = MATH_Vec4LenSq(c3);

    return (PRP_Bool)(MATH_IsZeroF32(d01) && MATH_IsZeroF32(d02) &&
                      MATH_IsZeroF32(d03) && MATH_IsZeroF32(d12) &&
                      MATH_IsZeroF32(d13) && MATH_IsZeroF32(d23) &&
                      MATH_AlmostEqF32(l0, 1.0f) &&
...
PRP_API MATH_Mat4 PRP_CALL MATH_Mat4Mul(MATH_Mat4 a, MATH_Mat4 b) {
    ...
    PRP_F32 a01 = a.membs[4], a11 = a.membs[5], a21 = a.membs[6],
            a31 = a.membs[7];
    PRP_F32 a02 = a.membs[8], a12 = a.membs[9], a22 = a.membs[10],
            a32 = a.membs[11];
    PRP_F32 a03 = a.membs[12], a13 = a.membs[13], a23 = a.membs[14],
            a33 = a.membs[15];

    PRP_F32 b00 = b.membs[0], b10 = b.membs[1], b20 = b.membs[2],
            b30 = b.membs[3];
    PRP_F32 b01 = b.membs[4], b11 = b.membs[5], b21 = b.membs[6],
            b31 = b.membs[7];
    PRP_F32 b02 = b.membs[8], b12 = b.membs[9], b22 = b.membs[10],
            b32 = b.membs[11];
    PRP_F32 b03 = b.membs[12], b13 = b.membs[13], b23 = b.membs[14],
            b33 = b.membs[15];
...
PRP_API PRP_F32 PRP_CALL MATH_Mat4Det(MATH_Mat4 a) {
    ...
    PRP_F32 s1 = m[0] * m[6] - m[2] * m[4];
    PRP_F32 s2 = m[0] * m[7] - m[3] * m[4];
    PRP_F32 s3 = m[1] * m[6] - m[2] * m[5];
    PRP_F32 s4 = m[1] * m[7] - m[3] * m[5];
    PRP_F32 s5 = m[2] * m[7] - m[3] * m[6];

    PRP_F32 c5 = m[10] * m[15] - m[11] * m[14];
    PRP_F32 c4 = m[9] * m[15] - m[11] * m[13];
    PRP_F32 c3 = m[9] * m[14] - m[10] * m[13];
    PRP_F32 c2 = m[8] * m[15] - m[11] * m[12];
    PRP_F32 c1 = m[8] * m[14] - m[10] * m[12];
    PRP_F32 c0 = m[8] * m[13] - m[9] * m[12];
...
PRP_API MATH_Mat4 PRP_CALL MATH_Mat4Orthonormalize(MATH_Mat4 a) {
    ...
    PRP_F32 proj10 = MATH_Vec4Dot(c1, c0);
    c1.x -= c0.x * proj10;
    c1.y -= c0.y * proj10;
    c1.z -= c0.z * proj10;
    c1.w -= c0.w * proj10;
    ...
    PRP_F32 proj20 = MATH_Vec4Dot(c2, c0);
    c2.x -= c0.x * proj20;
    c2.y -= c0.y * proj20;
    c2.z -= c0.z * proj20;
    c2.w -= c0.w * proj20;
    ...
    PRP_F32 proj21 = MATH_Vec4Dot(c2, c1);
    c2.x -= c1.x * proj21;
    c2.y -= c1.y * proj21;
    c2.z -= c1.z * proj21;
    c2.w -= c1.w * proj21;
    ...
    PRP_F32 proj30 = MATH_Vec4Dot(c3, c0);
    c3.x -= c0.x * proj30;
    c3.y -= c0.y * proj30;
    c3.z -= c0.z * proj30;
    c3.w -= c0.w * proj30;
    ...
    PRP_F32 proj31 = MATH_Vec4Dot(c3, c1);
    c3.x -= c1.x * proj31;
    c3.y -= c1.y * proj31;
    c3.z -= c1.z * proj31;
    c3.w -= c1.w * proj31;
    ...
    PRP_F32 proj32 = MATH_Vec4Dot(c3, c2);
    c3.x -= c2.x * proj32;
    c3.y -= c2.y * proj32;
    c3.z -= c2.z * proj32;
    c3.w -= c2.w * proj32;
