 ...
 *
 * @param pStr_arr Pointer to the string-array.
 *
 ...
 * @param ppStr_arr      Output pointer receiving the string-array.
 *
 ...
 *
 * @param pStr_arr  The string-array to clone.
 * @param ppStr_arr Output pointer receiving the string-array.
 *
 * @return PRP_OK on success.
 * @return PRP_ERR_OOM if allocation fails.
...
CONT_StrArrCloneUnchecked(const CONT_StrArr *pStr_arr, CONT_StrArr **ppStr_arr);
/**
 * Deep clones the given string-array.
 *
 * @param pStr_arr  The string-array to clone.
 ...
 *
 * @param ppStr_arr Pointer to string-array pointer.
 *
 * @note Unchecked variant:
 * - Asserts on invalid arguments in debug.
 */
 ...
 * @param i        The index into the string-array.
 * @param pStr_len Output pointer to store len of the string.
 * @param ppStr    Output pointer to store the string ptr.
 *
 * @return PRP_OK on success.
