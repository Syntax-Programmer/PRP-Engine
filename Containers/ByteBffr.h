 ...
 *
 * @param pB_bffr Pointer to the byte-buffer.
 *
 * @return PRP_True if valid, PRP_False otherwise.
 */
PRP_API PRP_Bool PRP_CALL CONT_ByteBffrIsValid(const CONT_ByteBffr *pB_bffr);

/**
 * Creates a dynamic byte-buffer.
 *
 * @param size     Initial size (in bytes) of the byte-buffer.
 * @param ppB_bffr Output pointer receiving the byte-buffer.
 *
 ...
 *
 * @param pB_bffr  The byte-buffer to clone.
 * @param ppB_bffr Output pointer receiving the byte-buffer.
 *
 * @return PRP_OK on success.
 * @return PRP_ERR_OOM if allocation fails.
 ...
 *
 * @param ppB_bffr Pointer to byte-buffer pointer.
 *
 * @note Unchecked variant:
 * - Asserts on invalid arguments in debug.
 */
 ...
 *
 * @return PRP_OK on success.
 * @return PRP_ERR_INV_ARG if ppB_bffr or *ppB_bffr is invalid.
 */
PRP_API PRP_Result PRP_CALL
 ...
 *
 * @param pB_bffr Byte-Buffer instance.
 ...
 *
 * @param pB_bffr1 Byte-Buffer instance 1.
 * @param ofs1     The ofset into the first byte-buffer.
 * @param pB_bffr2 Byte-Buffer instance 2.
 ...
 */
PRP_API PRP_Result PRP_CALL
CONT_ByteBffrCopyChecked(const CONT_ByteBffr *pB_bffr1, PRP_Size ofs1,
                         CONT_ByteBffr *pB_bffr2, PRP_Size ofs2, PRP_Size size);
/**
...
/**
 * Extends pB_bffr2 into pB_bffr1.
 *
 * @param pB_bffr1 Byte-Buffer instance 1.
 * @param pB_bffr2 Byte-Buffer instance 2.
 *
