 ...
 *
 * @param pDs_arr Pointer to the ds array.
 *
 ...
 * @param pElem_del_cb Optional cb to free internall alloc of element..
 * @param ppDs_arr     Output pointer receiving the array.
 *
 ...
 *
 * @param ppDs_arr Pointer to ds array pointer.
 *
 * @note Unchecked variant:
 * - Asserts on invalid arguments in debug.
 */
 ...
 *
 * @return PRP_OK on success.
 * @return PRP_ERR_INV_ARG if ppDs_arr or *ppDs_arr is invalid.
 */
PRP_API PRP_Result PRP_CALL CONT_DSArrDeleteChecked(CONT_DSArr **ppDs_arr);
/**
 * Returns the number of elements currently stored.
 *
 * @param pDs_arr DSArr instance.
 *
...
PRP_API PRP_Result PRP_CALL CONT_DSArrReserveChecked(CONT_DSArr *pDs_arr,
                                                     PRP_U32 count);
/**
 * Iterates over all elements of the ds array.
 *
 * @param pDs_arr    DSArr instance.
